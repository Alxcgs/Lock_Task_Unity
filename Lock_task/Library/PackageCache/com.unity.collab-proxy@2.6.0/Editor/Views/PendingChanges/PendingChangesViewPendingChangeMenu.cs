...
namespace Unity.PlasticSCM.Editor.Views.PendingChanges
{
    internal class PendingChangesViewPendingChangeMenu
    {
        ...
        {
            mPendingChangesMenuOperations.CopyFilePath(relativePath: false);
        }

        void CopyRelativeFilePathMenuItem_Click()
        {
            mPendingChangesMenuOperations.CopyFilePath(relativePath: true);
        }
        ...
        void UpdateMenuItems(GenericMenu menu)
        {
            ...
            if (operations.HasFlag(PendingChangesMenuOperations.CopyFilePath))
            {
                menu.AddItem(
            ...
            {
                menu.AddDisabledItem(mCopyFilePathMenuItemContent);
                menu.AddDisabledItem(mCopyRelativeFilePathMenuItemContent);
            }
